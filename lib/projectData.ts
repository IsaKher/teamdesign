...
Each event space has been conceived to accommodate gatherings of varying scales, from intimate family ceremonies to large public celebrations, with landscaped corridors between them that allow events to run in parallel without interference.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/w-4-1.jpg', caption: 'Landscaped corridors sized for procession — wide enough for a wedding party, intimate enough to feel intentional.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/w-8-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/w-10-1.jpg'], captions: ['The banquet corridor was designed to be a destination in itself. You arrive through it before you arrive at the hall.', 'The Rajasthani vocabulary — arches, carved stone, jaali — carried into the pavilion without becoming pastiche. That line required care.'] },
...
The building is experienced as much as seen: the transition from the bright forecourt into the cool interior of the sanctum, the quality of light at different times of day, the acoustic character of the space under prayer. The temple has become a significant community landmark in Kharghar since its completion.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/KALIMATA-MANDIR_Cam_03-1.jpg', caption: 'The shikara needed to be visible from the main road but not overpower the neighbourhood. We found that height through section, not mass.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/KALIMATA-MANDIR_Cam_04-1.jpg', caption: 'The rooftop courtyard was the last element to be resolved. The quality of light here at dawn, when the sanctum is first opened, vindicated every revision.' },
...
At 1.5 million square feet, this is one of the largest projects in the firm's portfolio. The scale demanded a planning logic that was both legible from the air and navigable on foot — the radiating geometry provides both.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Service-Industru-Education-Complex-Goa-4-1.jpg', caption: "The site's north-east constriction became the concept — five institutes radiating from a single entrance, each with its own identity, all sharing the same threshold." },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Service-Industru-Education-Complex-Goa-6-1.jpg', caption: 'At this scale the building is largely experienced from a vehicle. The facade needed to read as a series of episodes, not a single elevation.' },
...
The project demonstrates how sensitive site planning can achieve privacy and individuality within a multi-unit development — each bungalow occupies its own distinct position on the hillside, connected by landscaped paths rather than shared walls.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/MIST-VIEW-4-1.jpg', caption: 'Each bungalow was positioned individually on the hillside. No two look at the same thing — which at 2,200 feet was reason enough.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/MIST-VIEW-10-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/MIST-VIEW-6-1.jpg'], captions: ['The terrace was sized for the family, not for entertaining. It looks directly into the Western Ghats.', 'The south facade takes the full force of the Lonavala monsoon. The overhangs were calculated, not decorative.'] },
...
Student accommodation at this scale risks becoming anonymous. The design resists this through careful treatment of the common spaces — the ground-floor courtyard, the sky terraces at alternate floors, the social kitchen alcoves — that give each resident a sense of neighbourhood within the larger building.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/HOSTEL-BUILDING-4-1.jpg', caption: 'Eleven and sixteen storeys on a campus that had never exceeded four. The brief asked for presence without dominance — a difficult instruction to follow literally.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/HOSTEL-BUILDING-3-1.jpg', caption: 'The podium was designed to resist anonymity. Common rooms, studios, reading alcoves — deliberately undersized so they would always feel occupied.' },
...
The project is a study in the art of the annexe — how to add to a beloved existing structure without diminishing it. Each new element was tested against the question of whether it improves the estate as a whole, and only those that passed were retained in the final design.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/5-1.jpg', caption: 'The cantilever pool was the first thing the client asked for and the last thing we resolved. It needed to read as an extension of the original estate, not an interruption of it.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Mariwala-Estate-Annexe-4-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/1-1.jpg'], captions: ['Working within a 70,000 sq ft Art Deco estate meant every new element was in conversation with what was already there. The landscape was the mediator.', 'The original facade was restored before anything new was added. It seemed wrong to proceed otherwise.'] },
...
The design orientates main living spaces to catch the prevailing breeze, with deep overhangs that shade glazed elevations from direct sun while admitting diffused light throughout the day. Materials are responsive to the Tamil Nadu climate: cool stone floors, lime render on the exterior, and heavy masonry walls that moderate the internal temperature.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Luxuerious-5BHK-Villa-Mr-1.jpg', caption: "The deep cantilever roof was non-negotiable in Tirupur's climate. It also determined the proportions of the elevation — which is often how the best decisions get made." },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Luxuriewous-5BHK-Villa-Mr-1.jpg', caption: "The dining room opens to a garden sit-out on both sides. Strictly Vaastu — and, as it turned out, exactly right for the family's way of living." },
...
The design balances institutional credibility with accessibility — the ATM lobby is designed for frictionless 24-hour use, while the upper floor business centre carries the warmth and discretion required for high-value client meetings. The two programmes are distinct in character but unified by a consistent material language.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/J_K-Bank-Branch-Building-Samba-J_K-State-3-1.jpg', caption: 'A bank branch in a town that had never had one of this quality. The brief was partly about architecture and partly about what a building communicates about the people inside it.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/J_K-Bank-Branch-Building-Samba-J_K-State-4-1.jpg', caption: "The business centre on the upper floor was designed for conversations that needed privacy without formality. Light from the north, materials that don't impress." },
...
This project was followed, in 2005, by the adjacent MBA Hostel Towers, which brought a further 85,000 sq ft of student accommodation to the same campus. Team Design's decade-long involvement with ITM represents one of the firm's deepest institutional relationships.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/COLLEGE-CAMPUS-EXT-1-1.jpg', caption: 'The extension had to read as part of the existing campus, not as an addition to it. That meant studying what made the original buildings feel like a place.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/COLLEGE-CAMPUS-EXT-3-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/COLLEGE-CAMPUS-EXT-2-1.jpg'], captions: ["The central spine connects new to old without forcing a match. It's the one element that could afford to be unmistakably of its time.", 'Built while the campus was in full operation. Every sequence of construction was planned around the academic calendar.'] },
...
The brief called for a facility that would impress senior guests while remaining practical for extended stays. The suite arrangement balances the hotel-like quality expected by visiting executives with the comfort and ease of serviced accommodation, avoiding the impersonality of a corporate hotel.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/NRB-Bearings-Auragabad-1-1.jpg', caption: 'NRB makes bearings for aerospace and defence. Their guest house needed to reflect that standard — not through display, but through how carefully each space is resolved.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/NRB-Bearings-Auragabad-2-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/NRB-Bearings-Auragabad-3-1.jpg'], captions: ['The executive suites were designed to be genuinely restful. We spent considerable time on acoustic separation and on the lighting — it needed to work as well at midnight as it does at noon.', "The terrace garden became a café, a meeting space, and an outdoor room — sometimes all three at once. It was the client's favourite part of the brief."] },
...
The project posed a particular challenge: honouring the religious and community significance of the original temple while accommodating a contemporary mixed-use programme within a single cohesive architectural language. The solution carefully layers the secular and sacred so that each is enhanced by proximity to the other.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Gokul-Cam_021-1.jpg', caption: 'A building that holds a temple, two marriage halls, a dance academy, and a guest house — without any one function diminishing the others. The section is the design.' },
...
The result is a small structure with an outsized relationship to its site: from inside, the four trees become the walls, and the garden beyond becomes the room. The kitchen operates as much outdoors as in, with operable glass panels that dissolve the boundary entirely when the weather allows.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Glass-Kitchen-4-1.jpg', caption: 'The brief was a kitchen and study that wouldn\'t disturb the four corner trees. We built as little as possible — glass corners, minimal structure, a roof that floats.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Glass-Kitchen-2-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Glass-Kitchen-3-copy-1.jpg'], captions: ['The trees are inside the room. Or the room is inside the trees. The distinction dissolved during design and we stopped trying to recover it.', 'In the evening, when the panels are open and the candles are lit, the building disappears. That was the intention from the first sketch.'] },
...
The challenge was to give coherence to a campus that had begun without a master plan. The solution establishes a clear arrival sequence — from gate to courtyard to building entrance — that makes the campus feel intentional and complete, while the new wings continue the architectural language of the inherited structures.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/College-of-Engineerin-_-Management-Nagpur-1-1.jpg', caption: 'We inherited the campus part-built. The gate and arrival sequence were the first moves — you can\'t design a place people belong to without first designing the moment they enter.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/College-of-Engineerin-_-Management-Nagp-2-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/College-of-Engineerin-_-Management-Nagp-3-1.jpg'], captions: ['The academic wing was planned to maximise north light into classrooms without making the building read as a series of identical floors. Rhythm over repetition.', 'The campus courtyard was always in the master plan. It took two construction phases to complete. It was worth waiting for.'] },
...
The project demonstrates the firm's commitment to integrated design: the architectural envelope, the interior palette, and the landscape were developed as a single composition, with each element reinforcing the others.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Bungalow-in-Ahmedabad-Inida-1.jpg', caption: 'The east terrace was the first element fixed in plan. Everything else — bedrooms, circulation, car porch — arranged itself around the decision to face the morning light.' },
      { type: 'pullQuote', text: 'The bungalow has been meticulously planned, offering a perfect symphony of elegance and privacy.' },
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Bungalow-in-Ahmedabad-Inida-6.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Bungalow-in-Ahmedabad-Inida-5.jpg'], captions: ['Architecture, interiors, and landscape were developed together from the start. The living room expresses this most completely — the floor continues outside, the ceiling mediates both.', 'The garden was planted before the building was complete. By the time the family moved in, it already felt established.'] },
...
The project is a reminder that the finest residential architecture is measured not by its ambition but by how naturally it becomes home to the people who live in it.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/11/REVISED-CAM-3-.jpg', caption: 'Thick walls, deep shade, sheltered courtyards — the Rajasthani tradition understood its climate precisely. Our job was to translate that logic into a contemporary programme.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/11/REVISED-CAM-1-.jpg', 'https://teamdesign.in/wp-content/uploads/2018/11/LAYOUT.jpg'], captions: ['The entrance courtyard was sized to hold a small gathering — the logic of the haveli applied at the scale of a family home.', "The compound layout for two brothers' villas sharing a boundary — enough separation to live independently, enough shared threshold to remain family."] },
...
The building demonstrates that corporate architecture at the scale of an industrial estate can still be thoughtful and dignified — it need not apologise for its context, but it need not be defined by it either.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/PRECISION-METALS-1.jpg', caption: "A precision steel manufacturer's office on a 14-acre industrial site. The building was designed to have civic quality — to look like it belonged to its neighbourhood, not just to the factory behind it." },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/PRECISION-METALS-3-1.jpg', caption: 'The reception lobby was the point of encounter with clients and visitors. It needed to reflect the precision of what was made in the buildings behind it.' },
...
The layout allows women from all walks of life — a young mother with a newborn, a senior citizen on a wheelchair, a professional, or a teenager — to conduct banking operations with ease and satisfaction.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Women_s-Bank-Branch-J_K-Bank-Srinagar-2-1.jpg', caption: 'The autumn palette — deep amber, warm rust — takes its cue from chinar trees in October. The floor material, the fabrics, and the graphics all shift floor by floor.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Women_s-Bank-Branch-J_K-Bank-Srinagar-3-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Women_s-Bank-Branch-J_K-Bank-Srinagar-4-1.jpg'], captions: ["Spring floor: the lightest palette in the building. It sits between the warmth below and the restraint above.", "The winter palette was the hardest to agree on. Kashmir's winters are severe — we wanted the floor to feel like shelter, not severity."] },
...
The result is a flat that works hard for its size — intelligent planning makes it feel larger than its area suggests, while material choices ensure it photographs and presents with warmth rather than the clinical sterility that too often defines show homes.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/DSC_5945-1.jpg', caption: 'A show flat has two clients: the developer who needs it to sell apartments, and the family who will actually live there. We designed for the second.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/DSC_6006-1.jpg', caption: 'The master bedroom was designed to be quiet — acoustically and visually. In a show flat, that takes deliberate restraint.' },
...
The 600 sq mt office space sports executive cabins in the centre with staff along its periphery. Glass walls open up the area, allowing natural light to flood the space. Clean lines dress the office with a focus on functionality without compromising on storage, security and privacy. Yellow Jaisalmer stone slabs light up the floor and add zing to the interiors.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Unilazer-Ventures-Pvt-Ltd-10-1.jpg', caption: 'Sixty days to complete. The Yellow Jaisalmer stone floor went in last — it changed everything about the light in the space.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Unilazer-Ventures-Pvt-Ltd-8-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Unilazer-Ventures-Pvt-Ltd-5-1.jpg'], captions: ['The executive cabin has glass walls that preserve connection to the team without sacrificing the ability to close a door. A balance many clients ask for and few feel they deserve.', 'The entrance reception doubles as a waiting room and a gallery. The client has things worth looking at — we gave them somewhere to put them.'] },
...
The palette is deliberately restrained — walnut, stone, and polished metal — allowing the architecture to provide the assurance a financial institution requires while the Kashmiri craft elements bring warmth, regional identity, and the unmistakable quality of handwork that no corporate formula can replicate.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/J_K-Bank-NBC-BKC-12-1.jpg', caption: '70,000 sq ft of banking hall at Bandra Kurla Complex. The challenge was to feel Kashmiri without looking provincial — contemporary without losing identity.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/J_K-Bank-NBC-BKC-9-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/J_K-Bank-NBC-BKC-23-1.jpg'], captions: ['The walnut lattice is a direct translation of the pinjrakari woodwork tradition of Kashmir. The craftsmen were brought from the Valley. The detail took four weeks to resolve.', 'The private consultation rooms were the most resolved spaces in the building — small enough to feel personal, formal enough for serious conversations.'] },
...
This concept demonstrates how the bank branch — traditionally a civic space defined by queues and counters — can be reimagined as a place of discretion and ease, where the transaction is almost incidental to the quality of the environment.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/High-Networth-Bank-Branch-Shopian-10-1.jpg', caption: 'The Elite lounge was designed as a room you would want to stay in, not just pass through. For a bank branch in Shopian, that was an unusual aspiration — and worth having.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/High-Networth-Bank-Branch-Shopian-7-1.jpg', caption: 'The relationship manager suite needed to feel private without feeling closed. Partial-height partitions and careful acoustic treatment made the difference.' },
...
The design creates a workplace that balances the efficiency HDFC Bank requires with an environment that attracts and retains talent — warm enough to feel like a place where people choose to spend time, and disciplined enough to make that time productive.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/NSP_0096-1.jpg', caption: 'A corporate office designed to attract talent from a city where good offices are rare. The brief was partly spatial and partly about what the building says about working here.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/NSP_0010-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/NSP_9972-1.jpg'], captions: ['Open plan workstations with controlled acoustics. The desk spacing was calculated — enough room to spread drawings without encroaching on the person opposite.', 'The training room folds into a presentation space when the partition is removed. Used twice a week for client meetings, three times a week for internal sessions.'] },
...
A neutral interior palette serves as backdrop, with colour introduced through rugs, jaali designs, and soft furnishings. Warm and ambient lighting bestows a homely feel. Sustainable features include power-efficient LED fixtures, VRV/HVAC equipment, green-certified sanitary ware, and natural greenery ensuring environmental responsibility throughout.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Garden-Glory-Penthouse-Indian-Family-Thane-India-5-1.jpg', caption: "10,000 sq ft of terrace garden wrapping 5,000 sq ft of interior. The ratio was the client's instinct and our first constraint. It turned out to be the best brief we received." },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Garden-Glory-Penthouse-Indian-Family-Thane-India-4-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Garden-Glory-Penthouse-Indian-Family-Thane-India-10-1.jpg'], captions: ['The terrace garden is structured as a series of rooms — a dining terrace, a grove, a lawn — each with a different quality of enclosure.', 'The glass corridor connects interior to garden at every point. In the monsoon, when the garden is at its most intense, you can be inside and outside simultaneously.'] },
...
The result is a lounge that feels unmistakably of its place: specific to Srinagar in the way that the best airport environments honour their cities rather than erasing them.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/AIRPORT-LOUNGE-J_K-BANK-Srinagar-3-1.jpg', caption: "Papier-mâché, khatamband ceilings, sozni embroidery — the Valley's craft traditions carried into a contemporary hospitality setting without becoming a museum." },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/AIRPORT-LOUNGE-J_K-BANK-Srinagar-6-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/AIRPORT-LOUNGE-J_K-BANK-Srinagar-5-1.jpg'], captions: ['The craft detail was the hardest part of the project to protect through construction. It required on-site supervision at a level most projects don\'t demand.', "The seating was arranged to give everyone a view of the boarding gate without sacrificing the quality of the room. Airports are stressful. This lounge was designed not to be."] },
...
The result is a home that feels simultaneously disciplined and alive — a space in which the owners' collections, personalities, and daily routines are all given room to breathe.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Exclusive-Villa-Renouned-Indian-Family-Mumbai-India-2-1.jpg', caption: 'Dark flooring, wood-panelled walls, generous openings. A palette chosen to feel alive rather than composed — disciplined enough to hold together, warm enough to live in.' },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Exclusive-Villa-Renouned-Indian-Family-Mumbai-India-1-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Exclusive-Villa-Renouned-Indian-Family-Mumbai-India-6-1.jpg'], captions: ['The lower level is for gathering. The upper level is for the family. The section makes this legible without stating it.', 'The upper bedroom floor has a different character from the level below — quieter, more contained, with light controlled rather than invited.'] },
...
A much-talked-about design waiting to be built — this concept demonstrates how banking infrastructure can become a cultural landmark rather than a generic utility.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Electronic-Bank-Lobby-J_K-Bank-Srinagar-1-1.jpg', caption: "An E-Lobby at Lal Chowk — one of Srinagar's most charged addresses. The design needed to be confidently modern while carrying the weight of where it stood." },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Electronic-Bank-Lobby-J_K-Bank-Srinagar-4-1.jpg', caption: 'The digital floor graphics were a late addition to the brief and became its defining element. Technology in service of the space, not as a demonstration.' },
...
The project is one of the firm's most personally meaningful commissions — a private residence for Kishore Mariwala, founder of Marico, designed at the scale and quality befitting its address in South Mumbai. The completed home represents over two decades of working relationship between the client and the firm.`,
    ...
    contentBlocks: [
      ...
      },
      {
        ...
        caption: 'Designed at full scale, for a specific person. Every colour, picture, and piece of furniture was chosen for Mr. Mariwala — not for a notional resident.',
      },
      {
        type: 'pullQuote',
      ...
      },
      {
        ...
        captions: ['The study was the room we spent the most time on. It needed to accommodate serious work and serious reading — and be worth sitting in when neither was happening.', 'The master bedroom was the last room to be completed. By then we knew the client well enough to get it right.'],
      },
      {
        type: 'paragraph',
...
The project comes with the endorsement of the client himself — Gordon Serrao, a hotelier whose professional life is spent evaluating the quality of hospitality environments, praised the professionalism of the Team Design process from first meeting to handover.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Serrao-Home-3-1.jpg', caption: "A hotelier's home. The expectation of quality was non-negotiable — not for show, but because Mr. Serrao knows what quality feels like and doesn't forgive its absence." },
      ...
      { type: 'halfWidthImages', images: ['https://teamdesign.in/wp-content/uploads/2018/12/Serrao-Home-6-1.jpg', 'https://teamdesign.in/wp-content/uploads/2018/12/Serrao-Home-8-1.jpg'], captions: ['The family room was sized for Sunday mornings rather than formal gatherings. Earth tones, layered textiles, light from the east.', 'The master bedroom was designed to feel like a room in a good hotel — which, for this client, was both a reference and a standard.'] },
...
The cinema sits within a retail complex, and the design had to establish a distinct identity for the cineplex — a destination in its own right — while drawing visitors through the retail floors to reach it. The arrival sequence, from ground-floor entrance to upper-floor auditorium, is as much a part of the experience as the auditorium itself.`,
    ...
    contentBlocks: [
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Cinemarc-Cinema-Theatre-2-1.jpg', caption: 'A cineplex on the top floor of a shopping complex in Vadodara. The arrival sequence — escalator, atrium, lobby — was designed to be part of the experience before the film begins.' },
      ...
      { type: 'fullWidthImage', src: 'https://teamdesign.in/wp-content/uploads/2018/12/Cinemarc-Cinema-Theatre-5-1.jpg', caption: 'The auditorium was the technical challenge. Acoustics, sightlines, seat rake — and a ceiling designed to make the room feel intimate at 300 seats.' },
