  ...
  fields: [
    ...
    defineField({
      ...
      fields: [{
        ...
        title: 'Alt Text',
        type: 'string',
        description: 'Describe what\'s in the image for screen readers and SEO. e.g. "Northeast facade at dusk, Mist View Bungalows, Lonavala."',
    ...
    defineField({
      ...
      of: [{
        ...
        fields: [{
          ...
          title: 'Alt Text',
          type: 'string',
          description: 'Describe each image individually — what room, angle, or detail is shown. Helps screen readers and image search.',
          validation: (Rule) => Rule.required().warning('Alt text is recommended for accessibility'),
        }],
      }],
    }),
          ...
          fields: [
            {
              ...
              fields: [{
                ...
                title: 'Alt Text',
                type: 'string',
                description: 'Describe what\'s shown for screen readers and SEO.',
                validation: (Rule) => Rule.required().warning('Alt text is recommended for accessibility'),
              }],
            },
