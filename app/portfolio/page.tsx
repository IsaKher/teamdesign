...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://teamdesignarchitects.com/portfolio' },
  openGraph: {
    ...
    url: 'https://teamdesignarchitects.com/portfolio',
    images: [{ url: 'https://teamdesignarchitects.com/interiors-cta.webp', width: 1536, height: 1024, alt: 'Team Design Architects — Selected Work' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Portfolio — Team Design Architects',
    description: '300+ completed projects across residential, commercial, and institutional architecture.',
    images: ['https://teamdesignarchitects.com/interiors-cta.webp'],
  },
};
